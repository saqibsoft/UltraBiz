...
namespace DAL
{
    public class JournalVouchers
    {
        ...
        public void InsertRecord(Objects.JournalVouchers obj)
        {
            try
            {
                ...
                cmd.CommandText = "SP_JournalVouchersInsert";
        ...
        public void UpdateRecord(Objects.JournalVouchers obj)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SP_JournalVouchersUpdate";
        ...
        public void DeleteRecord(Int64 vID)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SP_JournalVouchersDelete";
        ...
        {
            string query = @"SELECT     * from JournalVouchers Where 1=1 {0}";
        ...
        public int getNextNo()
        {
            ...
            string vSql = "Select COALESCE(MAX(Isnull(VoucherNo,0)),0) + 1  as VoucherNo From JournalVouchers ";
