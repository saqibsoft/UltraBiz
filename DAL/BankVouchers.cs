...
namespace DAL
{
    public class BankVouchers
    {
        public string connectionstring;
        public void InsertRecord(Objects.BankVouchers obj)
        {
            try
            {
                ...
                cmd.CommandText = "SP_BankVouchersInsert";
        ...
        public void UpdateRecord(Objects.BankVouchers obj)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SP_BankVouchersUpdate";
        ...
        public void DeleteRecord(Int64 vID)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SP_BankVouchersDelete";
        ...
        {
            string query = @"SELECT     * from BankVouchers Where 1=1 {0}";
        ...
        public int getNextNo()
        {
            ...
            string vSql = "Select COALESCE(MAX(Isnull(VoucherNo,0)),0) + 1  as VoucherNo From BankVouchers ";
